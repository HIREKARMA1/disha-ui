...
function CreateModuleForm({ module, onSave, onCancel, jobContext }: CreateModuleFormProps) {
    ...
    const [formData, setFormData] = useState({
        ...
        category: (module?.category || 'aptitude-test') as PracticeCategory,
                        ...
                        <div className="space-y-3">
                            <div className="flex gap-2 min-w-0">
                                <input
                                    ...
                                    className="flex-1 min-w-0 p-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent text-sm"
