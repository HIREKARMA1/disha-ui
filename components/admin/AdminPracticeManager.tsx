        ...
        <>
            ...
            {isMounted && isCreateModuleModalOpen && createPortal(
                <div className="fixed inset-0 z-[9999] flex items-start sm:items-center justify-center overflow-y-auto bg-black/30 backdrop-blur-[2px] p-2 sm:p-4 py-4" style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0 }}>
                    <div className="relative w-full max-w-full sm:max-w-5xl max-h-[calc(100vh-2rem)] sm:max-h-[90vh] overflow-y-auto bg-white dark:bg-gray-900 rounded-xl sm:rounded-2xl shadow-2xl my-auto min-w-0">
                        <CreateModuleForm
                        ...
                        <div className="space-y-4">
                            <div className="flex gap-2 min-w-0">
                                <input
                                    ...
                                    className="flex-1 min-w-0 p-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent"
