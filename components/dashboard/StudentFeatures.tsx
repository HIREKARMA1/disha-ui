...
const getFeatureUrl = (featureKey: string) => {
  switch (featureKey) {
    case 'careeralign': return '/dashboard/student/careeralign'
    case 'analytics': return '/dashboard/student/analytics'
    case 'practice': return '/dashboard/student/practice'
    case 'video_search': return '/dashboard/student/video-search'
    case 'library': return '/dashboard/student/library'
    case 'resume': return '/dashboard/student/resume'
    case 'sadhana': return '/dashboard/student/sadhana'
    case 'sangha': return '/dashboard/student/sangha'
    default: return '#'
  }
}

export function StudentFeatures({ features, loading = false }: StudentFeaturesProps) {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">
            Contact your university administrator to enable features
          </p>
        </div>
      </div>
    )
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <span className="text-sm text-gray-500 dark:text-gray-400">
          {enabledFeatures.length} feature{enabledFeatures.length !== 1 ? 's' : ''} available
        </span>
      </div>
