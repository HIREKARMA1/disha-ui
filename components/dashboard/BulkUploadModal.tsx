                ...
                <div className="fixed inset-0 z-50 overflow-y-auto">   {/* allow scroll */}
                    <div className="flex items-center justify-center min-h-screen px-4 text-center">
                        ...
                        <motion.div
                            ...
                            className="relative w-full mx-4 sm:mx-0 align-bottom bg-white dark:bg-slate-800 rounded-xl text-left overflow-hidden shadow-[0_25px_50px_-12px_rgba(0,0,0,0.8)] transform transition-all sm:my-8 sm:align-middle sm:max-w-lg border-2 border-gray-300 dark:border-slate-600"
                            onClick={(e) => {
                        ...
                        >
                            ...
                            >
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                                            ...
                                            <button
                                                ...
                                                className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-3 py-2 bg-secondary-600 hover:bg-secondary-700 text-white rounded-lg text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
                                            >
                                    ...
                                    {/* Footer */}
                                    <div className="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-end gap-2 sm:gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                                        <button
                                            type="button"
                                            onClick={(e) => {
                                        ...
                                        <button
                                            ...
                                            className="w-full sm:w-auto px-4 py-2 text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
                                        >
