...
export function StudentProfile() {
    ...
    return (
        <div className="min-h-screen bg-[#F5F8FC] dark:bg-gray-900 pb-20 lg:pb-0">
            <Navbar />
            <StudentSidebar />
            <div className="pt-16 lg:pl-64">
                <main className="flex-1 p-3 sm:p-4 lg:p-6">
                    <div className="w-full max-w-[1400px] mx-auto">
                        {/* Hero */}
                        <div className="relative overflow-hidden rounded-2xl border border-primary-200/70 dark:border-primary-700/40 bg-gradient-to-br from-[#E8F4FF] via-white to-[#F0F7FF] dark:from-primary-900/30 dark:via-gray-800/90 dark:to-gray-900/90 p-4 sm:p-5 lg:p-6 mb-3 sm:mb-4 shadow-sm">
                            <div className="pointer-events-none absolute -top-12 -right-10 h-40 w-40 rounded-full bg-primary-300/25 blur-3xl" />
                            <div className="pointer-events-none absolute -bottom-16 left-10 h-36 w-36 rounded-full bg-sky-300/20 blur-3xl" />
                            <div className="relative flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-6">
                                <div className="flex-1 min-w-0">
                                    <h1 className="text-xl sm:text-2xl lg:text-[28px] font-bold text-gray-900 dark:text-white tracking-tight">
                                        Student Profile
                                    </h1>
                                    ...
                                    <div className="mt-3 flex flex-wrap gap-2">
                                        <span className="inline-flex items-center gap-1.5 rounded-full bg-white/90 dark:bg-gray-800/80 border border-gray-200 dark:border-gray-600 px-2.5 py-1 text-[11px] sm:text-xs font-medium text-gray-700 dark:text-gray-200 shadow-sm">
                                            <Calendar className="w-3 h-3 text-primary-500" />
                                            {todayLabel}
                                        </span>
                                        <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200/80 dark:border-emerald-700/50 px-2.5 py-1 text-[11px] sm:text-xs font-medium text-emerald-700 dark:text-emerald-300 shadow-sm">
                                            <TrendingUp className="w-3 h-3" />
                                            Career Growth
                                        </span>
                                        <span className="inline-flex items-center gap-1.5 rounded-full bg-sky-50 dark:bg-sky-900/30 border border-sky-200/80 dark:border-sky-700/50 px-2.5 py-1 text-[11px] sm:text-xs font-medium text-sky-700 dark:text-sky-300 shadow-sm">
                                ...
                                {/* Illustration */}
                                <div className="hidden sm:flex shrink-0 w-36 h-28 lg:w-48 lg:h-36 items-end justify-center relative">
                                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-primary-100 to-sky-100 dark:from-primary-900/40 dark:to-sky-900/30" />
                                    <svg viewBox="0 0 200 160" className="relative w-full h-full" aria-hidden>
                                        <ellipse cx="100" cy="140" rx="70" ry="10" fill="#00a2e5" opacity="0.15" />
                                        <rect x="55" y="70" width="90" height="55" rx="10" fill="#00a2e5" opacity="0.9" />
                                        <rect x="70" y="55" width="60" height="20" rx="6" fill="#098855" />
                                        ...
                                        <circle cx="160" cy="50" r="8" fill="#f58020" opacity="0.8" />
                                        <circle cx="40" cy="60" r="6" fill="#00a2e5" opacity="0.5" />
                                    </svg>
                                </div>
                                {/* Mobile compact illustration */}
                                <div className="sm:hidden absolute right-3 top-3 w-16 h-16 rounded-xl bg-gradient-to-br from-primary-100 to-sky-100 dark:from-primary-900/40 dark:to-sky-900/30 flex items-center justify-center opacity-90">
