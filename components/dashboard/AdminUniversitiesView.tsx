...
import { UniversityListItem, UniversityProfile, UpdateUniversityRequest } from '@/types/university'
...
export function AdminUniversitiesView({ hidePageHeader = false }: AdminUniversitiesViewProps) {
