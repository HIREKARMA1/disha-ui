...
import { CorporateListItem, CorporateProfile, UpdateCorporateRequest } from '@/types/corporate'
import { toast } from 'react-hot-toast'
import { getErrorMessage } from '@/lib/error-handler'
import { motion } from 'framer-motion'
import { Plus, Download, Upload } from 'lucide-react'

export interface AdminCorporatesViewProps {
    hidePageHeader?: boolean
}

export function AdminCorporatesView({ hidePageHeader = false }: AdminCorporatesViewProps) {
